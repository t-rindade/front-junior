...
export default function Login() {
    return(
        ...
        <section id="loginform">
            ...
            <div id="logodiv">
        <svg id="logoevent" width="293" height="51" viewBox="0 0 293 51" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="293" height="51" fill="white"/>
                ...
                <Link to="esqueceusenha" id="linkforget">Esqueceu a senha?</Link>
                <Link to="/home" id="linklogin">
